...
const CollectionCard: React.FC<CollectionCardProps> = ({ item, cartItems, handleAddToCart }): React.ReactElement => {
	...
	return (
		<Card width="10rem!important" onClick={clickAddToCart} className={isSelected ? ` ${styles.card_outline} ${styles.wrapper}` : styles.wrapper}>
			...
			<Box className={styles.card_button}>
				<Image src={eth} width="20" height="20" className={styles.round_img} />
